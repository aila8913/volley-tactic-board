...
#392 補填手勢（純前端）→ #393 寫入 events ＋ 秒數自動錨定 → #394 唯讀紀錄表格 →
**#395 球線分布＝M4 的 wow 點** → #396 表格可編輯 → #397 動作子分類。

⚠️ **不在那條線上的兩張，別以為要一起開工**：#375（個人能力雷達圖，卡自己的維度定義與少樣本
失真）、#404（影片多段管理 UI，資料層早就支援、純粹是 #391 刻意只做一段）。兩張都零相依、
隨時可插隊。#99（站位快照）同樣獨立。
