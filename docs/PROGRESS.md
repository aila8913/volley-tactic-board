...
\_Last updated: 2026-07-26 (tang) — #131 計分表整頁改版：背景／球場材質改吃跟戰術板共用的
`courtTheme` 模組（改一邊兩邊連動）、版面改左右發展（球場左／比分＋操作按鈕右，PR #195）；
合併時與 aila 的 #201（lineup/serving 死結修正）在同一段 JSX 衝突，已手動保留左右欄結構、
套用修正後的判準。前一批 2026-07-25 (aila) — #190–193 右欄三頁補齊（PR #201）＋修計分頁「有
發球方沒先發」死結（既有 bug，非本次引入；關聯 #64）。前一批 2026-07-25 (aila) — #127 補上
